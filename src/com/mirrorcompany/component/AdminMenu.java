...
public class AdminMenu extends javax.swing.JPanel {
    ...
    private void init(){
        listMenu1.addItem(new MenuModel("", "CONTROL PANEL", MenuModel.MenuType.TITLE));
        listMenu1.addItem(new MenuModel("", " ", MenuModel.MenuType.EMPTY));
        listMenu1.addItem(new MenuModel("8", "All Users", MenuModel.MenuType.MENU));
        listMenu1.addItem(new MenuModel("2", "Devices", MenuModel.MenuType.MENU));
        listMenu1.addItem(new MenuModel("1", "Billing-System", MenuModel.MenuType.MENU));
        listMenu1.addItem(new MenuModel("", " ", MenuModel.MenuType.EMPTY));
        listMenu1.addItem(new MenuModel("5", "Repports", MenuModel.MenuType.MENU));
        listMenu1.addItem(new MenuModel("3", "Notifications", MenuModel.MenuType.MENU));
        listMenu1.addItem(new MenuModel("", " ", MenuModel.MenuType.EMPTY));
        listMenu1.addItem(new MenuModel("6", "Support", MenuModel.MenuType.MENU));
    ...
    private void initComponents() {
        ...
        listMenu1.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
    ...
    protected void paintComponent(Graphics grphcs) {
        ...
        g2.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON); //0B5F56
